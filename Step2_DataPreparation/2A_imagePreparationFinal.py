...
#    Purpose : Program takes the original images and crops the areas of interest from those.
#    The areas of interest for this program are the central rectangles. That will create a new image file just for the 
#    single grid image or two new files for the two grid image. In addition, the polygon text file for use in YOLO is 
