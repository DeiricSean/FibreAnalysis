...
#from torchvision. import engine as eng
...
class FibreDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Plot the contours
        #plt.imshow(mask, cmap='gray')  # Plot the mask image as the background
    ...
    # Append the contour mask to the masks list
            ...
            # Reshape the contour array to match the format expected by matplotlib
        #     reshaped_contour = contour.squeeze()
            
        #     # Plot the contour
        #     plt.plot(reshaped_contour[:, 0], reshaped_contour[:, 1], 'r')  # Use red color ('r') for the contour
